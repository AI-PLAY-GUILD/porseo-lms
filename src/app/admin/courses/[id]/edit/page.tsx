...
export default function EditCoursePage() {
    ...
    if (userData === undefined || course === undefined || allVideos === undefined) {
        return (
    ...
    if (course === null) return <div className="p-8">コースが見つかりません</div>;
    ...
    const videoMap = new Map(allVideos.map((v) => [v._id, v]));

    return (
        <div className="p-8 max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold mb-8">コース編集</h1>
