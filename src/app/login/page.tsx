    ...
    return (
        <div className="auth-root">
            ...
            <main className="auth-card-wrap">
                ...
                <div className="auth-clerk-wrap" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '1rem' }}>
                    <button
                        onClick={handleDiscordLogin}
                        disabled={!isLoaded}
                        className="auth-submit-btn"
                        style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.9rem 1.5rem', width: '100%', justifyContent: 'center', fontSize: '1.05rem', cursor: isLoaded ? 'pointer' : 'not-allowed' }}
                    >
                    ...
                    <div style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.85rem' }}>
                        ...
                        <a href="/join" style={{ fontWeight: 'bold', color: '#0ea5e9', textDecoration: 'none' }}>新規登録はこちら</a>
                    </div>
                </div>

                <div className="auth-footer-links">
                    <a href="/terms" className="auth-footer-link">利用規約</a>
                    <span className="auth-footer-dot">·</span>
                    <a href="/privacy" className="auth-footer-link">プライバシーポリシー</a>
                </div>
            </main>
            ...
            <div className="z-10 mt-6">
                ...
                >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2 rotate-180">
