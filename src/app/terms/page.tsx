...
export default function TermsPage() {
    return (
        <LegalPageLayout title="利用規約" updatedAt="2026年02月21日">
            <p>
            ...
            <h2>中途解約の場合のサービス提供の有無</h2>
            <p>
                中途解約の場合であっても、元々ご契約頂いた契約期間の終期までの間は、ご解約頂いたプランに係る商品・サービス及びこれに含まれるコンテンツを継続してご利用いただけます。
            </p>

            <h2>コンテンツのご利用</h2>
            <p>
                当社は、ユーザーに対し、本サービスが提供する文章、画像、動画、音声、音楽、ソフトウェア、プログラム、コードその他のコンテンツについて、本サービスの利用範囲内における私的な利用を許諾します。有償コンテンツについては、当社が定める利用料金の支払が完了した場合に、本サービスの利用範囲内における私的な利用を許諾します。これは、譲渡及び再許諾できない、非独占的な利用権です。この範囲を超えて本サービスが提供するコンテンツを利用することは一切禁止します。<br />
