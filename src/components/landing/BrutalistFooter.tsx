                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><Link href="#features" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">特徴</Link></li>
                            <li><Link href="#pricing" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">料金プラン</Link></li>
                            <li><Link href="/dashboard" className="text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors">ダッシュボード</Link></li>
                        </ul>
                    </div>
