...
export function BrutalistFooter() {
    return (
        <footer className="py-16 border-t border-white/10 relative z-10 bg-[#f6f6f8] dark:bg-[#101622] text-foreground">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="col-span-1 md:col-span-2">
                        <Link href="/" className="flex items-center gap-2 mb-6 group">
                            <span className="text-2xl font-thin text-foreground tracking-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                                AI PLAY GUILD
                            </span>
                        </Link>
