import { Bomb, Gamepad2, LineChart, Megaphone, Terminal, Users } from "lucide-react";
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-20">
                    <h2 className="text-3xl sm:text-5xl md:text-7xl font-black mb-6 text-black uppercase tracking-tighter">
                        Why{" "}
                        <span className="bg-pop-purple text-white px-4 transform -rotate-2 inline-block border-4 border-black">
                            AI Play Guild?
                        </span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            <div
                                className={`w-16 h-16 rounded-xl ${feature.color} border-4 border-black flex items-center justify-center mb-6 group-hover:rotate-6 transition-transform duration-200`}
                            >
