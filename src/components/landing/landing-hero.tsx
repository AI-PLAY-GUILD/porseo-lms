...
export function LandingHero({ isSignedIn, handleCheckout, checkoutLoading }: LandingHeroProps) {
    ...
    useGSAP(
        () => {
            ...
            tl.fromTo(titleRef.current, { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 1, delay: 0.2 })
                ...
                .fromTo(buttonsRef.current, { y: 20, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 }, "-=0.6");
        },
        { scope: containerRef },
    );
    ...
    return (
        <section
            ref={containerRef}
            className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-20 text-center z-10"
        >
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row items-center gap-4 opacity-0">
                {isSignedIn ? (
                    <Button
                        asChild
                        size="lg"
                        className="h-14 px-8 text-lg rounded-full bg-white text-black hover:bg-gray-200 transition-all shadow-[0_0_30px_rgba(255,255,255,0.3)]"
                    >
                        <Link href="/dashboard">
                    ...
                    <>
                        <Button
                            asChild
                            size="lg"
                            className="h-14 px-8 text-lg rounded-full bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-500 hover:to-violet-500 text-white transition-all shadow-[0_0_30px_rgba(79,70,229,0.4)]"
                        >
                        ...
                        <Button
                            ...
                            variant="outline"
                            size="lg"
                            className="h-14 px-8 text-lg rounded-full border-white/20 bg-transparent hover:bg-white/10 text-white transition-all"
                        >
