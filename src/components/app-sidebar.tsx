            ...
            <SidebarContent className="bg-cream p-2 gap-4">
                {data.navMain.map((group) => (
                    <SidebarGroup key={group.title}>
                        <SidebarGroupLabel className="text-black font-black text-sm uppercase tracking-wider mb-2 px-2">
                            {group.title}
                        </SidebarGroupLabel>
                        <SidebarGroupContent>
            ...
            <SidebarFooter className="bg-cream p-4 gap-2">
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton
                            size="lg"
                            className="text-black cursor-default hover:bg-transparent border-2 border-transparent rounded-lg"
                        >
                            <Avatar className="h-8 w-8 rounded-lg border-2 border-black">
                                <AvatarImage src={userData.avatar} alt={userData.name} />
                                <AvatarFallback className="rounded-lg bg-pop-green font-bold text-black">
                                    CN
                                </AvatarFallback>
                            </Avatar>
